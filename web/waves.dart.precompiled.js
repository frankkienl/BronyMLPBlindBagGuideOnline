...
["", "waves.dart", , M, {
  main: function() {
    var t1, t2;
    t1 = H.setRuntimeTypeInfo(Array(), [V.AbstractWave]);
    $.waves = t1;
    t2 = new V.Wave1(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t2.Wave1$0();
    t1.push(t2);
    t2 = $.waves;
    t1 = new V.Wave2(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t1.Wave2$0();
    t2.push(t1);
    t1 = $.waves;
    t2 = new V.Wave3(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t2.Wave3$0();
    t1.push(t2);
    t2 = $.waves;
    t1 = new V.Wave4(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t1.Wave4$0();
    t2.push(t1);
    t1 = $.waves;
    t2 = new V.Wave5(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t2.Wave5$0();
    t1.push(t2);
    t2 = $.waves;
    t1 = new V.Wave6(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t1.Wave6$0();
    t2.push(t1);
    t1 = $.waves;
    t2 = new V.Wave7(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t2.Wave7$0();
    t1.push(t2);
    t2 = $.waves;
    t1 = new V.Wave8(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t1.Wave8$0();
    t2.push(t1);
    t1 = $.waves;
    t2 = new V.Wave8_1(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t2.Wave8_1$0();
    t1.push(t2);
    t2 = $.waves;
    t1 = new V.Wave8_2(null, null, null, H.setRuntimeTypeInfo(Array(), [V.Pattern]), null, null, null);
    t1.Wave8_2$0();
    t2.push(t1);
    M.initUI();
  },
  initUI: function() {
    var the_content, t1, i, t2, t3, row, t4, t5, image, title;
    the_content = document.querySelector("#the_content");
    for (t1 = J.getInterceptor$x(the_content), i = 0; i < $.waves.length; ++i) {
      ...
      t5 = t4.get$classes(row);
      t5.add$1(t5, "rowWave");
      image = W._ElementFactoryProvider_createElement_tag("img", null);
      t5 = t4.get$children(row);
      t5.add$1(t5, image);
      J.get$attributes$x(image)._element.setAttribute("src", "assets/" + ("Wave " + J.toString$0(t3.wave) + "/cover.jpg"));
      image.setAttribute("height", "150");
      title = W._ElementFactoryProvider_createElement_tag("div", null);
      t3 = t3.waveName;
      t5 = J.getInterceptor$x(title);
      t5.set$innerHtml(title, C.JSString_methods.$add(C.JSString_methods.$add("<a href=\"wave.html?wave=", t3) + "\">Wave ", t3) + "</a>");
      t5 = t5.get$classes(title);
      t5.add$1(t5, "rowWaveTitle");
      t4 = t4.get$children(row);
      t4.add$1(t4, title);
      t2.add$1(t2, row);
    }
  }
